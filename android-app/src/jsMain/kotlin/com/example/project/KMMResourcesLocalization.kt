...
actual fun L.Listofobjects.Categories.Samplecategory.Content.body(): String = getString("l.listofobjects.categories.samplecategory.content.$index.body")
actual fun L.Listofobjects.Categories.Samplecategory.Content.title(): String = getString("l.listofobjects.categories.samplecategory.content.$index.title")
